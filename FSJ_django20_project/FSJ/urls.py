...
urlpatterns = [
    ...
    path('coord_awardslist/<str:award_idnum>/applications/view/<str:application_idnum>/', views.coordinator_application_view, name = 'coord_applicationview'),
    ...
    path('coord_awardslist/<str:award_idnum>/applications/send_to_archive/', views.coordinator_application_archive, name = 'coord_application_archive'),
